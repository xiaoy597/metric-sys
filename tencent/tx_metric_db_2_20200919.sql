...
Source Database       : tx_metric_db_2

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2020-09-19 18:03:53
*/
...
CREATE TABLE `daily_metric` (
  `dept_cd` char(18) NOT NULL COMMENT '部门代码 -- ',
  ...
  `metric_amend_value` decimal(20,4) DEFAULT NULL COMMENT '指标修订值 -- ',
...
CREATE TABLE `dim_code` (
  `dim_code_id` int(11) NOT NULL COMMENT '维度代码标识 -- ',
  `dim_code_type` char(4) DEFAULT NULL COMMENT '维度代码类型 -- ',
  `dim_code_cd` varchar(60) DEFAULT NULL COMMENT '维度代码值 -- ',
  `dim_code_desc` varchar(512) DEFAULT NULL COMMENT '维度代码描述 -- ',
  PRIMARY KEY (`dim_code_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='维度代码表 -- ';
...
CREATE TABLE `metric_dim` (
  ...
  `dim_code_type` varchar(30) DEFAULT NULL COMMENT '维度代码类型 -- ',
...
CREATE TABLE `monthly_metric` (
  `dept_cd` varchar(20) NOT NULL COMMENT '部门代码 -- ',
  `d_month` int(11) NOT NULL COMMENT '月份 -- ',
  `metric_row_id` bigint(20) NOT NULL COMMENT '指标记录标识 -- ',
  `metric_value` decimal(20,4) DEFAULT NULL COMMENT '指标值 -- ',
  `metric_amend_value` decimal(20,4) DEFAULT NULL COMMENT '指标修订值 -- ',
